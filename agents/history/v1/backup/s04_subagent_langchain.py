#!/usr/bin/env python3
"""
s04_subagent_langchain.py - 子智能体

创建一个子智能体，使用空的 messages=[]。子智能体在独立的上下文中工作，
共享文件系统，然后只向父智能体返回一个摘要。
...
from tools import CHILD_TOOLS, PARENT_TOOLS, TOOL_HANDLERS, WORKDIR
