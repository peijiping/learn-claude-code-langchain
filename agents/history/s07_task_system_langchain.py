#!/usr/bin/env python3
"""
s07_task_system_langchain.py - 任务系统

任务以JSON文件的形式持久化在.tasks/目录中，这样它们能够在上下文压缩中存活下来。
每个任务都有一个依赖图（blockedBy/blocks）。
    ...
    +----------+     +----------+     +----------+
         |                ^
         +--- 完成task 1会将其从task 2的blockedBy中移除

核心洞察："状态能够在压缩中存活——因为它在对话之外。"
"""
